...
def test_mrt_block():
    ...
    blk_bytes = pcapng.mrt.mrt_block_pack(2, 3, list(range(1, 6)))
...
def test_mrt_block_ext():
    pcapng.util.test_time_utc_set(123.456789)
    blk_bytes = pcapng.mrt.mrt_block_extended_pack(4, 5, list(range(1, 8)))
...
def test_isis_block():
    pcapng.util.test_time_utc_set(123.456789)
    blk_bytes = pcapng.mrt.mrt_isis_block_pack( list(range(1, 6)))
...
def test_isis_block_ext():
    pcapng.util.test_time_utc_set(123.456789)
    blk_bytes = pcapng.mrt.mrt_isis_block_extended_pack( list(range(1, 8)))
